...
print('Solar System {} has maximum number of {} planets out of all the solar systems we have discovered so far.'
.format(max_solar_system, solar_system_planet_count[max_solar_system]))
...
hd_10180_planets_mass.append(1)

hd_10180_planets_name.append('Earth')

fig = px.bar(x = hd_10180_planets_name, y = hd_10180_planets_mass)
...
fig = px.scatter(x = planet_radius, y = planet_masses)
...
for planet_data in suitable_planets:
  distance = 2.0 * 3.14 * (planet_data[8] * 1.496e+9)
  time = planet_data[9] * 86400.0
  speed = distance / time
